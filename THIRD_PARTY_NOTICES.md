...
VisitorTrace supports user-supplied and automatically downloaded MMDB files from DB-IP City Lite, MaxMind GeoLite2 City, and IP2Location LITE DB11. No GeoIP database or provider credential is included in this repository. Each database remains subject to its own license, terms, account requirements, download limits, and attribution requirements. See the provider documentation: <https://db-ip.com/db/lite.php>, <https://dev.maxmind.com/geoip/geolite2-free-geolocation-data/>, and <https://lite.ip2location.com/ip2location-lite>.
