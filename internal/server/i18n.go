...
var messages = map[string]map[string]string{
	"zh-CN": {
		...
		"site_count": "个 Site", "add_site": "新增 Site", "manage_sites": "管理站点", "site_management_help": "集中查看各站点状态、统计与公开入口。", "operations_attention": "运行状态需要关注", "operations": "运行状态", "backup_now": "立即备份", "restore_backup": "恢复备份", "restore_backup_help": "从服务器上的本地备份恢复数据库。恢复前会自动创建安全快照，服务将重启且管理员需要重新登录。", "choose_backup": "选择备份", "restore_now": "恢复并重启", "no_backups": "暂无可用备份。", "checksum_missing": "缺少校验文件",
		...
		"transparent_background": "透明背景", "background": "背景色", "land": "陆地", "border": "边界", "text": "文字", "marker": "标记", "restore_defaults": "恢复默认", "save_preset": "保存预设",
		...
		"flash_site": "Site 已创建。", "flash_settings": "站点设置已保存。", "flash_preset": "Map Preset 已保存。", "flash_reset": "Site 数据已清空；采集和公开展示保持关闭。", "restore_backup_confirm": "恢复该备份将覆盖当前数据库，服务会重启，当前管理员会话也会失效。确定继续吗？", "restore_restarting": "正在恢复备份并重启服务", "restore_restart_help": "已完成归档校验并创建恢复前安全备份。服务重启后将激活所选数据库；请等待片刻后重新登录后台。",
		...
		"err_csrf": "请求令牌无效。", "err_site_not_found": "Site 不存在。", "err_read_sites": "无法读取站点。", "err_read_site_stats": "无法读取站点统计。", "err_read_preset": "无法读取 Map Preset。", "err_read_records": "无法读取 Pageview Record。", "err_read_backups": "无法读取备份文件。", "err_read_analytics": "无法读取聚合分析。", "err_encode_analytics": "无法编码聚合分析。", "err_read_map": "无法读取访客地图。", "err_encode_map": "无法编码访客地图。",
		"err_pagination_direction": "分页方向无效。", "err_pagination_cursor": "分页游标无效或与当前筛选不匹配。", "err_site_form": "站点表单无效。", "err_preset_form": "Map Preset 表单无效。", "err_password_form": "密码表单无效。", "err_confirm_form": "确认表单无效。",
		"err_admin_https": "管理员后台需要 HTTPS；本机回环地址可使用 HTTP 预览。", "err_create_session": "无法创建登录会话。", "err_create_csrf": "无法创建安全令牌。", "err_save_session": "无法保存登录会话。", "err_record_password_check": "无法记录密码验证状态。", "err_credential": "无法生成密码凭据。", "err_update_password": "无法更新管理员密码。",
		"err_admin_password": "管理员密码不正确。", "err_current_password": "当前密码不正确。", "err_password_mismatch": "两次输入的新密码不一致。", "err_config_path": "服务配置路径不可用。",
		"err_geoip_refresh_busy": "另一项 Pageview 地理信息刷新正在运行。", "err_geoip_unavailable": "GeoIP 数据库当前不可用。", "err_geoip_refresh_failed": "无法刷新 Pageview 地理信息：", "err_geoip_mode": "GeoIP 更新模式无效。", "err_geoip_url_required": "自定义 GeoIP 下载地址不能为空。", "err_geoip_source": "GeoIP 下载源类型无效。", "err_geoip_url_long": "GeoIP 下载地址过长。", "err_geoip_disabled": "GeoIP 自动更新已在配置中关闭。", "err_geoip_settings_failed": "GeoIP 更新设置无效：", "err_geoip_update_failed": "GeoIP 更新失败：",
		"err_backup_failed": "备份失败：", "err_cleanup_failed": "清理失败：", "err_backup_missing": "备份文件不可用：", "err_backup_verify_failed": "备份校验失败：", "err_restore_pending": "已有备份恢复任务正在等待服务重启。", "err_restore_schedule_failed": "安排恢复失败：", "err_restore_snapshot_failed": "创建恢复前安全备份失败：",
		"err_manifest_read": "无法读取签名发布清单。", "err_manifest_max_bytes": "发布清单必须小于 %d 字节。", "err_binary_too_large": "发布二进制大小超出允许范围。", "err_choose_manifest": "请选择签名发布清单。", "err_choose_binary": "请选择当前平台的发布二进制。", "err_local_update_read": "无法读取本地更新文件：", "err_update_failed": "更新失败：", "err_no_update_key": "当前构建未嵌入自更新签名公钥。", "err_not_stable_path": "服务未从稳定更新路径启动，请先运行 update bootstrap 并调整进程管理器。",
		"err_filter_limit": "每页数量必须是 50、100 或 200", "err_filter_method": "采集方式筛选无效", "err_filter_from": "起始时间无效", "err_filter_to": "结束时间无效", "err_filter_range": "起始时间不能晚于结束时间", "err_filter_path": "路径筛选无效", "err_filter_ip": "IP 筛选无效", "err_filter_digest": "Visitor Digest 必须是 64 位十六进制值", "err_filter_long_site_id": "Site ID筛选过长", "err_filter_long_hostname": "访问域名筛选过长", "err_filter_long_country": "国家筛选过长", "err_filter_long_region": "地区筛选过长", "err_filter_long_city": "城市筛选过长", "err_filter_long_browser": "浏览器筛选过长", "err_filter_long_os": "操作系统筛选过长",
		"err_login_rate_limited": "登录尝试过于频繁，请稍后再试。", "err_login_invalid": "登录请求无效。", "err_login_password": "密码不正确。", "flash_password_changed": "管理员密码已更新，请重新登录。", "err_credential_conflict_maxmind": "不能同时清除和替换 MaxMind 凭证", "err_credential_long_maxmind": "MaxMind 凭证过长", "err_credential_conflict": "不能同时清除和替换 %s", "err_credential_long": "%s 过长",
		"err_step_up": "需要重新验证管理员密码。", "err_site_id_mismatch": "输入的 Site ID 不匹配。", "confirm_site_id": "输入 Site ID 确认", "confirm_site_id_help": "永久删除前请输入该 Site 的 ID 以确认。", "reset_site_confirm": "确定清空该 Site 的全部访问数据？该操作不可撤销。", "delete_site_confirm": "确定永久删除该 Site？删除后 Site ID 不会复用。", "password_change_notice": "保存后全部登录会话（包括当前会话）都会失效，需要重新登录。", "stepup_dialog_title": "验证管理员身份", "stepup_dialog_body": "该操作需要重新验证身份，请输入管理员密码。", "stepup_submit": "验证并继续",
	},
	"en": {
		...
		"site_count": "Sites", "add_site": "Add Site", "manage_sites": "Manage Sites", "site_management_help": "Review each Site's state, totals, and public entry point.", "operations_attention": "Operations need attention", "operations": "Operations", "backup_now": "Back up now", "restore_backup": "Restore backup", "restore_backup_help": "Restore the database from a local backup on this server. A safety snapshot is created first; the service restarts and Administrators must sign in again.", "choose_backup": "Backup archive", "restore_now": "Restore and restart", "no_backups": "No local backups are available.", "checksum_missing": "checksum missing",
		...
		"transparent_background": "Transparent background", "background": "Background", "land": "Land", "border": "Borders", "text": "Text", "marker": "Markers", "restore_defaults": "Restore defaults", "save_preset": "Save preset",
		...
		"flash_site": "Site created.", "flash_settings": "Site settings saved.", "flash_preset": "Map Preset saved.", "flash_reset": "Site data reset; ingestion and public views remain disabled.", "restore_backup_confirm": "Restoring this backup replaces the current database, restarts the service, and invalidates the current Administrator session. Continue?", "restore_restarting": "Restoring backup and restarting service", "restore_restart_help": "The archive was verified and a pre-restore safety snapshot was created. The selected database will be activated after restart; sign in again when the service is ready.",
		...
		"err_csrf": "The request token is invalid.", "err_site_not_found": "Site not found.", "err_read_sites": "Unable to read Sites.", "err_read_site_stats": "Unable to read Site statistics.", "err_read_preset": "Unable to read the Map Preset.", "err_read_records": "Unable to read Pageview Records.", "err_read_backups": "Unable to read backup archives.", "err_read_analytics": "Unable to read analytics.", "err_encode_analytics": "Unable to encode analytics.", "err_read_map": "Unable to read the visitor map.", "err_encode_map": "Unable to encode the visitor map.",
		"err_pagination_direction": "Invalid pagination direction.", "err_pagination_cursor": "Invalid pagination cursor or filter mismatch.", "err_site_form": "Invalid Site form.", "err_preset_form": "Invalid Map Preset form.", "err_password_form": "Invalid password form.", "err_confirm_form": "Invalid confirmation form.",
		"err_admin_https": "The Admin Console requires HTTPS; loopback addresses may use HTTP for previewing.", "err_create_session": "Unable to create a login session.", "err_create_csrf": "Unable to create a security token.", "err_save_session": "Unable to save the login session.", "err_record_password_check": "Unable to record the password verification.", "err_credential": "Unable to generate password credentials.", "err_update_password": "Unable to update the Administrator password.",
		"err_admin_password": "The Administrator password is incorrect.", "err_current_password": "The current password is incorrect.", "err_password_mismatch": "The new passwords do not match.", "err_config_path": "The service configuration path is unavailable.",
		"err_geoip_refresh_busy": "Another Pageview geography refresh is already running.", "err_geoip_unavailable": "The GeoIP database is currently unavailable.", "err_geoip_refresh_failed": "Unable to refresh Pageview geography: ", "err_geoip_mode": "Invalid GeoIP update mode.", "err_geoip_url_required": "The custom GeoIP download URL cannot be empty.", "err_geoip_source": "Invalid GeoIP download source type.", "err_geoip_url_long": "The GeoIP download URL is too long.", "err_geoip_disabled": "Automatic GeoIP updates are disabled in the configuration.", "err_geoip_settings_failed": "Invalid GeoIP update settings: ", "err_geoip_update_failed": "GeoIP update failed: ",
		"err_backup_failed": "Backup failed: ", "err_cleanup_failed": "Cleanup failed: ", "err_backup_missing": "Backup archive unavailable: ", "err_backup_verify_failed": "Backup verification failed: ", "err_restore_pending": "A backup restore is already waiting for the service to restart.", "err_restore_schedule_failed": "Failed to schedule the restore: ", "err_restore_snapshot_failed": "Failed to create the pre-restore safety snapshot: ",
		"err_manifest_read": "Unable to read the signed release manifest.", "err_manifest_max_bytes": "The release manifest must be smaller than %d bytes.", "err_binary_too_large": "The release binary exceeds the allowed size.", "err_choose_manifest": "Choose the signed release manifest.", "err_choose_binary": "Choose the release binary for the current platform.", "err_local_update_read": "Unable to read the local update files: ", "err_update_failed": "Update failed: ", "err_no_update_key": "This build does not embed the self-update signing public key.", "err_not_stable_path": "The service is not launched from the stable update path; run update bootstrap and adjust the process manager first.",
		"err_filter_limit": "Per page must be 50, 100, or 200", "err_filter_method": "Invalid collection method filter", "err_filter_from": "Invalid start time", "err_filter_to": "Invalid end time", "err_filter_range": "The start time cannot be later than the end time", "err_filter_path": "Invalid path filter", "err_filter_ip": "Invalid IP filter", "err_filter_digest": "Visitor Digest must be 64 hexadecimal characters", "err_filter_long_site_id": "Site ID filter is too long", "err_filter_long_hostname": "Hostname filter is too long", "err_filter_long_country": "Country filter is too long", "err_filter_long_region": "Region filter is too long", "err_filter_long_city": "City filter is too long", "err_filter_long_browser": "Browser filter is too long", "err_filter_long_os": "Operating system filter is too long",
		"err_login_rate_limited": "Too many login attempts; try again later.", "err_login_invalid": "Invalid login request.", "err_login_password": "Incorrect password.", "flash_password_changed": "The Administrator password was updated; sign in again.", "err_credential_conflict_maxmind": "Cannot clear and replace MaxMind credentials at the same time", "err_credential_long_maxmind": "MaxMind credentials are too long", "err_credential_conflict": "Cannot clear and replace %s at the same time", "err_credential_long": "%s is too long",
		"err_step_up": "Re-verify the Administrator password to continue.", "err_site_id_mismatch": "The entered Site ID does not match.", "confirm_site_id": "Type the Site ID to confirm", "confirm_site_id_help": "Type this Site's ID to confirm permanent deletion.", "reset_site_confirm": "Clear all analytics data for this Site? This cannot be undone.", "delete_site_confirm": "Permanently delete this Site? The Site ID will never be reused.", "password_change_notice": "After saving, every session (including this one) is signed out and you must sign in again.", "stepup_dialog_title": "Verify Administrator identity", "stepup_dialog_body": "This action needs a fresh password check; enter the Administrator password.", "stepup_submit": "Verify and continue",
	},
	"ja": {
		"dashboard": "ダッシュボード", "sites": "サイト管理", "records": "Pageview 記録", "settings": "管理者設定", "logout": "ログアウト", "admin_navigation": "管理者ナビゲーション",
		"site_count": "サイト", "add_site": "サイトを追加", "manage_sites": "サイトを管理", "site_management_help": "各サイトの状態、集計、公開ページを確認します。", "operations_attention": "要確認の運用項目", "operations": "運用状況", "backup_now": "今すぐバックアップ", "restore_backup": "バックアップを復元", "restore_backup_help": "このサーバー上のローカルバックアップからデータベースを復元します。先に安全なスナップショットを作成し、サービスを再起動します。復元後は管理者の再ログインが必要です。", "choose_backup": "バックアップを選択", "restore_now": "復元して再起動", "no_backups": "利用可能なローカルバックアップはありません。", "checksum_missing": "チェックサムなし",
		...
		"transparent_background": "透明な背景", "background": "背景", "land": "陸地", "border": "境界線", "text": "テキスト", "marker": "マーカー", "restore_defaults": "デフォルトに戻す", "save_preset": "プリセットを保存",
		...
		"flash_site": "サイトを作成しました。", "flash_settings": "サイト設定を保存しました。", "flash_preset": "Map Preset を保存しました。", "flash_reset": "サイトデータをリセットしました。収集と公開表示は無効のままです。", "restore_backup_confirm": "このバックアップを復元すると現在のデータベースが置き換えられ、サービスが再起動し、現在の管理者セッションが無効になります。続行しますか？", "restore_restarting": "バックアップを復元してサービスを再起動しています", "restore_restart_help": "アーカイブの検証と復元前の安全なスナップショット作成が完了しました。再起動後に選択したデータベースを有効化します。しばらくしてから再ログインしてください。",
		...
		"err_csrf": "リクエストトークンが無効です。", "err_site_not_found": "サイトが見つかりません。", "err_read_sites": "サイトを読み取れません。", "err_read_site_stats": "サイトの統計を読み取れません。", "err_read_preset": "Map Preset を読み取れません。", "err_read_records": "Pageview 記録を読み取れません。", "err_read_backups": "バックアップファイルを読み取れません。", "err_read_analytics": "分析データを読み取れません。", "err_encode_analytics": "分析データをエンコードできません。", "err_read_map": "訪問者マップを読み取れません。", "err_encode_map": "訪問者マップをエンコードできません。",
		"err_pagination_direction": "ページ送り方向が無効です。", "err_pagination_cursor": "ページ送りカーソルが無効か、フィルターと一致しません。", "err_site_form": "サイトフォームが無効です。", "err_preset_form": "Map Preset フォームが無効です。", "err_password_form": "パスワードフォームが無効です。", "err_confirm_form": "確認フォームが無効です。",
		"err_admin_https": "管理者コンソールには HTTPS が必要です。ループバックアドレスでは HTTP でプレビューできます。", "err_create_session": "ログインセッションを作成できません。", "err_create_csrf": "セキュリティトークンを作成できません。", "err_save_session": "ログインセッションを保存できません。", "err_record_password_check": "パスワード検証状態を記録できません。", "err_credential": "パスワード資格情報を生成できません。", "err_update_password": "管理者パスワードを更新できません。",
		"err_admin_password": "管理者パスワードが正しくありません。", "err_current_password": "現在のパスワードが正しくありません。", "err_password_mismatch": "新しいパスワードが一致しません。", "err_config_path": "サービス設定のパスが利用できません。",
		"err_geoip_refresh_busy": "別の Pageview 位置情報更新が実行中です。", "err_geoip_unavailable": "GeoIP データベースは現在利用できません。", "err_geoip_refresh_failed": "Pageview の位置情報を更新できません: ", "err_geoip_mode": "GeoIP 更新モードが無効です。", "err_geoip_url_required": "カスタム GeoIP ダウンロード URL は空にできません。", "err_geoip_source": "GeoIP ダウンロード元の種類が無効です。", "err_geoip_url_long": "GeoIP ダウンロード URL が長すぎます。", "err_geoip_disabled": "GeoIP 自動更新は設定で無効になっています。", "err_geoip_settings_failed": "GeoIP 更新設定が無効です: ", "err_geoip_update_failed": "GeoIP 更新に失敗しました: ",
		"err_backup_failed": "バックアップに失敗しました: ", "err_cleanup_failed": "クリーンアップに失敗しました: ", "err_backup_missing": "バックアップファイルが利用できません: ", "err_backup_verify_failed": "バックアップの検証に失敗しました: ", "err_restore_pending": "バックアップの復元がサービスの再起動を待機しています。", "err_restore_schedule_failed": "復元のスケジュールに失敗しました: ", "err_restore_snapshot_failed": "復元前の安全なスナップショット作成に失敗しました: ",
		"err_manifest_read": "署名済みリリースマニフェストを読み取れません。", "err_manifest_max_bytes": "リリースマニフェストは %d バイト未満である必要があります。", "err_binary_too_large": "リリースバイナリが許容サイズを超えています。", "err_choose_manifest": "署名済みリリースマニフェストを選択してください。", "err_choose_binary": "現在のプラットフォーム用のリリースバイナリを選択してください。", "err_local_update_read": "ローカル更新ファイルを読み取れません: ", "err_update_failed": "更新に失敗しました: ", "err_no_update_key": "このビルドには自己更新用の署名公開鍵が埋め込まれていません。", "err_not_stable_path": "サービスが安定した更新パスから起動されていません。先に update bootstrap を実行し、プロセスマネージャーを調整してください。",
		"err_filter_limit": "1ページあたりの件数は 50、100、200 のいずれかです", "err_filter_method": "収集方法のフィルターが無効です", "err_filter_from": "開始時刻が無効です", "err_filter_to": "終了時刻が無効です", "err_filter_range": "開始時刻は終了時刻より後にはできません", "err_filter_path": "パスのフィルターが無効です", "err_filter_ip": "IP のフィルターが無効です", "err_filter_digest": "Visitor Digest は64桁の16進値である必要があります", "err_filter_long_site_id": "Site ID のフィルターが長すぎます", "err_filter_long_hostname": "ホスト名のフィルターが長すぎます", "err_filter_long_country": "国のフィルターが長すぎます", "err_filter_long_region": "地域のフィルターが長すぎます", "err_filter_long_city": "都市のフィルターが長すぎます", "err_filter_long_browser": "ブラウザーのフィルターが長すぎます", "err_filter_long_os": "OS のフィルターが長すぎます",
		"err_login_rate_limited": "ログイン試行が多すぎます。しばらくしてからもう一度お試しください。", "err_login_invalid": "ログインリクエストが無効です。", "err_login_password": "パスワードが正しくありません。", "flash_password_changed": "管理者パスワードが更新されました。再ログインしてください。", "err_credential_conflict_maxmind": "MaxMind 認証情報の削除と置き換えは同時に行えません", "err_credential_long_maxmind": "MaxMind 認証情報が長すぎます", "err_credential_conflict": "%s の削除と置き換えは同時に行えません", "err_credential_long": "%s が長すぎます",
		"err_step_up": "続行するには管理者パスワードを再確認してください。", "err_site_id_mismatch": "入力された Site ID が一致しません。", "confirm_site_id": "確認のため Site ID を入力", "confirm_site_id_help": "完全削除の前に、この Site の ID を入力して確認します。", "reset_site_confirm": "この Site のすべてのアクセスデータを消去しますか？この操作は取り消せません。", "delete_site_confirm": "この Site を完全に削除しますか？Site ID は再利用されません。", "password_change_notice": "保存すると、すべてのセッション（現在のものを含む）が無効になり、再ログインが必要になります。", "stepup_dialog_title": "管理者の本人確認", "stepup_dialog_body": "この操作には改めての本人確認が必要です。管理者パスワードを入力してください。", "stepup_submit": "確認して続行",
	},
}
