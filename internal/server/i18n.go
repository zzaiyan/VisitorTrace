...
var messages = map[string]map[string]string{
	"zh-CN": {
		...
		"save_settings": "保存站点设置", "combined_widget": "一体式接入", "separate_tracker": "分离式接入", "widget_resource": "Widget", "tracker_resource": "Tracker", "map_resource": "Map SVG", "embed_code": "嵌入代码", "resource_url": "资源地址", "map_control": "地图控件代码", "recent_records": "最近记录", "filter_page_export": "筛选、分页与导出",
	...
	"en": {
		...
		"save_settings": "Save Site settings", "combined_widget": "Integrated", "separate_tracker": "Separated", "widget_resource": "Widget", "tracker_resource": "Tracker", "map_resource": "Map SVG", "embed_code": "Embed code", "resource_url": "Resource URL", "map_control": "Map control code", "recent_records": "Recent records", "filter_page_export": "Filter, paginate, and export",
