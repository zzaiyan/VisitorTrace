...
var messages = map[string]map[string]string{
	"zh-CN": {
		...
		"save_settings": "保存站点设置", "combined_widget": "一体式接入", "separate_tracker": "分离式接入", "widget_resource": "Widget", "javascript_widget": "交互式 Widget", "image_widget": "Image Widget", "recommended": "推荐", "compatibility_mode": "兼容模式", "image_widget_limitations": "无需 JavaScript；不创建浏览器 Visitor ID，路径默认取 Referer。图片代理、预取或缓存可能只展示地图而不计数；固定页面可在 URL 中加入 path 参数。", "tracker_resource": "Tracker", "map_resource": "Map SVG", "embed_code": "嵌入代码", "resource_url": "资源地址", "map_control": "地图控件代码", "recent_records": "最近记录", "filter_page_export": "筛选、分页与导出", "collection_method": "采集方式", "all_methods": "全部方式",
	...
	"en": {
		...
		"save_settings": "Save Site settings", "combined_widget": "Integrated", "separate_tracker": "Separated", "widget_resource": "Widget", "javascript_widget": "Interactive Widget", "image_widget": "Image Widget", "recommended": "Recommended", "compatibility_mode": "Compatibility", "image_widget_limitations": "No JavaScript required. It creates no browser Visitor ID and uses Referer for the default path. Image proxies, prefetching, or caches may render without counting; add a path parameter for a fixed page.", "tracker_resource": "Tracker", "map_resource": "Map SVG", "embed_code": "Embed code", "resource_url": "Resource URL", "map_control": "Map control code", "recent_records": "Recent records", "filter_page_export": "Filter, paginate, and export", "collection_method": "Collection method", "all_methods": "All methods",
