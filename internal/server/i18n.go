...
var messages = map[string]map[string]string{
	"zh-CN": {
		...
		"all_sites": "全部 Site", "from_utc": "起始时间（UTC）", "to_utc": "结束时间（UTC）", "path": "路径", "original_ip": "原始 IP",
		...
		"save_settings": "保存设置", "combined_widget": "一体式 Widget", "separate_tracker": "分离式 Tracker", "recent_records": "最近记录", "filter_page_export": "筛选、分页与导出",
	...
	"en": {
		...
		"all_sites": "All Sites", "from_utc": "Start time (UTC)", "to_utc": "End time (UTC)", "path": "Path", "original_ip": "Original IP",
		...
		"save_settings": "Save settings", "combined_widget": "Combined Widget", "separate_tracker": "Separate Tracker", "recent_records": "Recent records", "filter_page_export": "Filter, paginate, and export",
